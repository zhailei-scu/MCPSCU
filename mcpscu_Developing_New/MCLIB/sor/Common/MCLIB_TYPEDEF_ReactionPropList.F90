    ...
    subroutine PrintOutCheckingResult(this,hFile,BasicAtomsList,TheReactionsMap)
        ...
        DO While(associated(cursor))
            ...
            write(hFile,fmt="('!','The reaction subject symbol =',A30,2x,  &
                              ...
                              '!','Reaction Coefficents value =',1PE10.8,2x, &
                              '!','PreFactor = ',1PE10.8,2x, &
                              '!','ActEnergy = ',1PE10.8,2x, &
                              '!','Production type = ',I1,2x, &
                              '!','SubjectElement = ',A10,2x, &
                              '!','ObjectElement = ',A10,2x, &
                              '!','ECR Generate way =',I1,2x, &
                              '!','ECR Value =',1PE10.8)")                     cursor%Reaction%SubjectSymbol, &
                ...
                DO While(associated(SubjectClusterListCursor))
                    ...
                    DO While(associated(ObjectClusterListCursor))
                        ...
                        write(hFile,fmt="('! |--','The subject symbol =',A30,2x,  &
                                          ...
                                          '!','ECR Generate way =',I1,2x, &
                                          '!','ECR Value =',1PE10.8)")         SubjectSymbol,                       &
                                                                               ObjectSymbol,                        &
