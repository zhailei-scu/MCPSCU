...
!*********************************************************************************!
  ...
  !***  DESCRIPTION:
  !     This module provides a typedef that data operation.
  !
  !
  !
  ...
  implicit none
     ...
     !----
          ...
          if(.not.associated(From)) then
             ...
             call CopyFromA_DataPad(From%Next, To%Next)
          return
     ...
     !----
          ...
          if(.not.associated(From)) then
             ...
             if(present(For)) then
                ...
                call CopyFromB_DataPad(From%Next, To%Next, For)
             else
                call CopyFrom0_DataPad(To, From, At)
                call CopyFromB_DataPad(From%Next, To%Next, At)
             end if
          return
          ...
          if(.not.associated(DatList)) then
             ...
             if(SameFirstWord(Tag, DatList%Tag)) then
                pDat => DatList
                 ...
                 call GetDataByTag_DataPad(Tag, DatList%Next, pDat)
             end if
          end if
          return
