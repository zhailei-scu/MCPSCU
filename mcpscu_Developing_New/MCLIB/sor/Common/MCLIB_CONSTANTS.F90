module MCLIB_CONSTANTS
    ...
    integer,parameter::mp_SelfAdjustlStep_NNDR_S4 = 4      ! the time step is determined by the NNDR algorithm S4
    integer,parameter::mp_SelfAdjustlStep_NNDR_LastPassage = 5      ! the time step is determined by the NNDR algorithm LastPassage
    integer,parameter::mp_SelfAdjustlStep_NNDR_Integer = 6      ! the time step is determined by the NNDR algorithm but is integer times of lower limit
    integer,parameter::mp_SelfAdjustlStep_NNDR_LastPassage_Integer = 7      ! the time step is determined by the NNDR algorithm LastPassage but is integer times of lower limit
