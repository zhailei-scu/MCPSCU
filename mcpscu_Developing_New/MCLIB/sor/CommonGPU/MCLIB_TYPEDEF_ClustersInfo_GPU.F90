module MCLIB_TYPEDEF_ClustersInfo_GPU
    USE cudafor
    ...
    type,public::ClustersInfo_GPU
        ...
        integer,device,dimension(:),allocatable::dm_WithInRegion
    ...
    subroutine CleanClusterInfo_GPU(this)
        ...
        call DeAllocateArray_GPU(this%dm_WithInRegion,"dm_WithInRegion")
    ...
    subroutine Allocate_ClustersInfo_GPU(this,AllocSize,NeighborhoodsNum)
        ...
        if(AllocSize .GT. 0) then
            ...
            call AllocateArray_GPU(this%dm_WithInRegion,AllocSize,"dm_WithInRegion")
            this%dm_WithInRegion = 0
    ...
    integer function Get_MemoryConsuming_OneClusterInfo_GPU(this,NeighborhoodsNum)
        ...
        Get_MemoryConsuming_OneClusterInfo_GPU = sizeof(oneClusterInfo_GPU%dm_Clusters) + &
                                                 ...
                                                 sizeof(oneClusterInfo_GPU%dm_WithInRegion)
...
end module MCLIB_TYPEDEF_ClustersInfo_GPU
